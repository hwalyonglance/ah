...
class CourseCategoryAPIController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return $this->sendResponse(CourseCategoryResource::collection($courseCategories), 'Course Categories retrieved successfully');
    }
    ...
    public function store(CreateCourseCategoryAPIRequest $request)
    {
        ...
        return $this->sendResponse(new CourseCategoryResource($courseCategory), 'Course Category saved successfully');
    }
    ...
    public function show($id)
    {
        ...
        return $this->sendResponse(new CourseCategoryResource($courseCategory), 'Course Category retrieved successfully');
    }
    ...
    public function update($id, UpdateCourseCategoryAPIRequest $request)
    {
        ...
        return $this->sendResponse(new CourseCategoryResource($courseCategory), 'CourseCategory updated successfully');
    }
